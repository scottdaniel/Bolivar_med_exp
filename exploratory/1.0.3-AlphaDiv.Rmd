...
#o full model (multiple linear regression) statistics for alpha diversity in children
...
write.table(lm.stats.tbl, file = "../output/tables/alpha_lm_stats.txt", sep = "\t", row.names = F, quote = F)
