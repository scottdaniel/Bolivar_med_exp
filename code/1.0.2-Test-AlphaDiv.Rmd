...
# Obtain the full linear model
fit.full <- lm(paste0(AA, " ~ Age_num + Urban + Gender + Age_num:Urban + Age_num:Gender + Urban:Gender"), data = Work_dat)
...
lm_models[[YY]] <- lm(regforward.out$terms, data = Work_dat, contrasts = list(Urban = "contr.sum", Gender = "contr.sum"))

car::Anova(lm_models[[YY]], type = 3)
car::Anova(lm_models[[YY]], type = 3) %>% eta_squared()
